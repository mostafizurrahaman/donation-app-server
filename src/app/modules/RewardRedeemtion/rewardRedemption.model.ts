// src/app/modules/Reward/rewardRedemption.model.ts
...
rewardRedemptionSchema.methods.generateQRCode =
  async function (): Promise<string> {
    ...
    // Base64 encode for simple QR (you can use a QR library for actual QR generation)
